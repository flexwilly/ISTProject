        ...
        <div class="row">
          <div class="col-md-8 m-auto">
            <div class="card border border-danger ">
              <h3 id="form-header" class="bg-danger text-white text-center p-3">Form Title</h3>
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-12 mb-3">
                    <div class="form-group">
                      <textarea  class="form-control form-text"  id="message" placeholder="Message"></textarea>
                    </div> 
                  </div> 
                </div>
                <div class="row">
                  <div class="col-md-12 mb-3">
                    <div class="form-group">                                
                      <input  id="form-button" type="submit" value="Submit" class="form-control btn btn-outline-danger btn-block">
                  </div>
                  </div>
                </div>
