  ...
  <body>
    <div class="d-flex" id="wrapper">
      ...
      <div class="bg-white" id="sidebar-wrapper">
        ...
        >
          <i class="fas fa-dumbbell"></i>Debbs Gym
        </div>
        <div class="list-group list-group-flush my-3">
          ...
          <a
            ...
            ><i class="fas fa-project-diagram me-2"></i>Projects</a
          >
          <a
            href="#"
            class="list-group-item list-group-item-action bg-transparent second-text fw-bold"
      ...
      <div id="page-content-wrapper">
        ...
        >
          <div class="d-flex align-items-center">
            <i
              class="fas fa-align-left text-dark fs-4 me-3"
              id="menu-toggle"
            ></i>
            <h2 class="fs-2 m-0">Customer Dashboard</h2>
          </div>
        ...
        <div class="container-fluid px-4">
          <div class="row g-3 my-2">
            ...
            <div class="col-md-4">
              ...
              >
                ...
                <i
                  class="fa-solid fa-person-biking fs-1 primary-text border rounded-full secondary-bg p-3"
                ></i>
              </div>
            </div>
          ...
          <!--First table display-->
          <div class="row my-5">
            <h3 class="fs-4 mb-3 text-center">Recent Orders</h3>
            <div class="col">
