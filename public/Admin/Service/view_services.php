...
<body>
   <!--NavBar-->
                ...
                <ul class="navbar-nav ms-auto">
                                  <li class="nav-item dropdown">
                                      ...
                                      <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                                          <li><a class="dropdown-item active" href="view_services.php ">View Services</a></li>
                                          <li><hr class="dropdown-divider"></li>
                                          <li><a class="dropdown-item " href="create_service.php">Create Service</a>
                                          </li>         
                                      </ul>
                                  </li>
                                  <li class="nav-item">
    ...
    <section class="table-section mt-4 mb-4">
        <div class="container">
                <div class="row">
                          <h1 id="form-header" class="text-center">View All Services</h1>
                        <div class="col-md-8 m-auto">
                                <table id="view-service-table" class="table table-striped border border-dark">
                                        <thead class="text-white bg-danger text-center">

                                                <tr>
                                                        <th id="table-heading" scope="col">Service Name</th>
                                                        <th id="table-heading" scope="col">Service Price</th>
                                                        <th id="table-heading" scope="col">Service Image</th>
                                        ...
                                        <tbody class="text-center">
                                                ...
                                                foreach($s1 as $service){
                                                echo "<tr class ='col'>
                                                <td class='form-text'>$service[service_name]</td>
                                                <td class='form-text' >$service[service_price]</td>
                                                <td><img class='rounded-circle' src='../../images/$service[pic_name]'width = '100' height='100'></td>
                                                <td><a id='form-button' class='btn btn-danger text-white' href='delete_service.php?service_id=$service[service_id]'>Delete</a></td>
                                                <td><a id='form-button' class='btn btn-success' href='update_service.php?service_id=$service[service_id]'>Update</a></td>
                                                </tr>"
                                                ;     
                                                }
                                                ?>     
