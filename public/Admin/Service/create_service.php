                  ...
                  <ul class="navbar-nav ms-auto">
                                  <li class="nav-item dropdown">
                                      ...
                                      <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                                          <li><a class="dropdown-item " href="view_services.php ">View Services</a></li>
                                          <li><hr class="dropdown-divider"></li>
                                          <li><a class="dropdown-item active" href="create_service.php">Create Service</a>
                                          </li>         
                                      </ul>
                                  </li>
                                  <li class="nav-item">
